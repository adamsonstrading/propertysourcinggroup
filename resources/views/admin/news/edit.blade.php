...
<head>
    ...
    <title>Edit Blog - PSG Admin</title>
            ...
            <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if($news->image_url)
                            <div class="mb-2"><img src="{{ asset('storage/' . $news->image_url) }}" height="100"
                ...
                <div class="d-grid mt-4">
                    <button type="submit" class="btn btn-pink btn-lg py-3 fw-bold">Update Blog Post</button>
                </div>
            </form>
        </div>
    </div>
