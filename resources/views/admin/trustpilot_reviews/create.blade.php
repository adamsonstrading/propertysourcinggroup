...
@section('title', 'Add Trustpilot Review')

@section('content')
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2>Add Trustpilot Review</h2>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.1" min="0" max="5" class="form-control" id="rating_stars"
                            name="rating_stars" value="{{ old('rating_stars', 5.0) }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="review_text" name="review_text"
                            value="{{ old('review_text') }}" placeholder="e.g. 1920" required>
                    </div>
