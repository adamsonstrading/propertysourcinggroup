        ...
        <div class="col-lg-12">
            <div class="content-card">
                ...
                <div class="col-lg-8">
                    <div class="card shadow-sm mb-4 border-0">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0 fw-bold text-blue"><i class="fas fa-info-circle me-2"></i>Basic Information</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <label class="form-label fw-bold">Property Headline</label>
                                <input type="text" name="headline" class="form-control form-control-lg"
                                    placeholder="e.g. Luxury 5 Bedroom Villa in London" value="{{ old('headline', $property->headline) }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="location-input" name="location" class="form-control border-start-0 ps-0"
                                        placeholder="Search UK address..." value="{{ old('location', $property->location) }}" required>
                                </div>
                            ...
                            <div class="mb-0">
                                <label class="form-label fw-bold text-blue"><i class="fas fa-align-left me-2"></i>Full Description</label>
                                <textarea name="full_description" id="editor" class="form-control" rows="10">{{ old('full_description', $property->full_description) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm mb-4 border-0">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0 fw-bold text-blue"><i class="fas fa-tools me-2"></i>Property Specifications</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select name="unit_type_id" id="unit_type_id" class="form-select">
                                        ...
                                        @foreach($unitTypes as $type)
                                            <option value="{{ $type->id }}"
                                                data-property-type="{{ $type->property_type_id }}"
                                                {{ (old('unit_type_id', $property->unit_type_id) == $type->id) ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="area_sq_ft" class="form-control" placeholder="e.g. 1500"
                                    ...
                                    <div class="row" id="bed-bath-section">
                                        <div class="col-md-6">
                                            ...
                                            <select name="bedrooms" class="form-select">
                                                ...
                                                @endfor
                                                <option value="10+" {{ old('bedrooms', $property->bedrooms) == '10+' ? 'selected' : '' }}>10+</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select name="bathrooms" class="form-select">
                                                ...
                                                @endfor
                                                <option value="10+" {{ old('bathrooms', $property->bathrooms) == '10+' ? 'selected' : '' }}>10+</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm mb-4 border-0">
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0 fw-bold text-blue"><i class="fas fa-images me-2"></i>Media & Gallery</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                @if($property->thumbnail)
                                    <div class="mb-2">
                                        <img src="{{ Storage::url($property->thumbnail) }}" alt="Thumbnail" class="img-fluid rounded border shadow-sm" style="max-height: 150px;">
                                    </div>
                                @endif
                                ...
                                @if($property->gallery_images)
                                    <div class="d-flex flex-wrap gap-2 mb-2">
                                        @foreach($property->gallery_images as $image)
                                            <img src="{{ Storage::url($image) }}" alt="Gallery" class="img-thumbnail" style="width: 60px; height: 60px; object-fit: cover;">
                                        @endforeach
                                    </div>
                                @endif
                    ...
                    <div class="card shadow-sm border-0 bg-light border-top border-4 border-primary">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="form-check mb-4 d-inline-block text-start">
                                <input class="form-check-input" type="checkbox" name="discount_available" id="discountCheck"
                                    {{ old('discount_available', $property->discount_available) ? 'checked' : '' }}>
                                <label class="form-check-label fw-bold" for="discountCheck">
                                    Mark as Discounted Property
                                </label>
                            </div>
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg fw-bold shadow-sm py-3 mb-2">
                                    <i class="fas fa-sync-alt me-2"></i>Update Property
                                </button>
                                <a href="{{ route('admin.available-properties.index') }}" class="btn btn-light btn-lg small text-muted border">
                                    Back to List
                                </a>
                            </div>
                        </div>
