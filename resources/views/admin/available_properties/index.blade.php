                ...
                <tbody>
                    @forelse($properties as $property)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.available-properties.update-status', $property->id) }}" method="POST" class="status-form">
                                    @csrf
                                    <select name="status" class="form-select form-select-sm fw-600 status-select text-dark" style="min-width: 120px; background-color: #fff; border-color: #dee2e6;" onchange="this.form.submit()">
                                        @if(auth()->user()->role === 'admin')
